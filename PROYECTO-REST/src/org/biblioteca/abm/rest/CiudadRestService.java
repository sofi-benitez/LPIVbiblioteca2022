...
import org.biblioteca.facade.CiudadSession;

//http://localhost:8080/PROYECTO-REST/rest/
@Path("ciudad")
public class CiudadRestService {
	@EJB
	CiudadSession cs;//Inyeccion de dependencia (cs = ciudadSession)
	...
	// GET http://localhost:8080/PROYECTO-REST/rest/ciudad/find/n
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Path("/find/{codigo}")
